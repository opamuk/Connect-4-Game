...
$('td').click(function(){
  ...
  //
  //     a=$('td').eq(q).css('background-color');
  //     b=$('td').eq(q+1).css('background-color')
  //     c=$('td').eq(q+2).css('background-color')
  //     d=$('td').eq(q+3).css('background-color')
  //     if(a===b&&b===c&&c===d&&d==="rgb(255, 0, 0)"){
  //       $('.change').remove()
  //       $('h1').text(two+' has won. Refresh the page to restart')
  //     }else if (a===b&&b===c&&c===d&&d==="rgb(0, 0, 255)"){
  ...
  //
  //     a=$('td').eq(q).css('background-color');
  //     b=$('td').eq(q+7).css('background-color')
  //     c=$('td').eq(q+14).css('background-color')
  //     d=$('td').eq(q+21).css('background-color')
  //     if(a===b&&b===c&&c===d&&d==="rgb(255, 0, 0)"){
  //
  //       $('.change').remove()
  //       $('h1').text(two+' has won. Refresh the page to restart')
  ...
  //   for(z=0;z<=2;z++){
  //     a=$('td').eq(q).css('background-color');
  //     b=$('td').eq(q+6).css('background-color')
  //     c=$('td').eq(q+12).css('background-color')
  //     d=$('td').eq(q+18).css('background-color')
  //     if(a===b&&b===c&&c===d&&d==="rgb(255, 0, 0)"){
  //       $('.change').remove()
  //       $('h1').text(two+' has won. Refresh the page to restart')
  //     }else if (a===b&&b===c&&c===d&&d==="rgb(0, 0, 255)"){
  ...
  //   for(z=0;z<=2;z++){
  //     a=$('td').eq(q).css('background-color');
  //     b=$('td').eq(q+8).css('background-color')
  //     c=$('td').eq(q+16).css('background-color')
  //     d=$('td').eq(q+24).css('background-color')
  //     if(a===b&&b===c&&c===d&&d==="rgb(255, 0, 0)"){
  //       $('.change').remove()
  //       $('h1').text(two+' has won. Refresh the page to restart')
  //     }else if (a===b&&b===c&&c===d&&d==="rgb(0, 0, 255)"){
